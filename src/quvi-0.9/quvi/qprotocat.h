...
typedef enum
{
  QUVI_MEDIA_SCRIPT_PROTOCOL_CATEGORY_RTMPE = 1<<0,
  QUVI_MEDIA_SCRIPT_PROTOCOL_CATEGORY_RTMP  = 1<<1,
  QUVI_MEDIA_SCRIPT_PROTOCOL_CATEGORY_RTSP  = 1<<2,
  QUVI_MEDIA_SCRIPT_PROTOCOL_CATEGORY_HTTP  = 1<<3,
  QUVI_MEDIA_SCRIPT_PROTOCOL_CATEGORY_MMS   = 1<<4,
